package org.techpliead.logback.testing;
 ...
 * override its functionality to capture final encoded event into the list {@link EncodedMessageCaptureConsoleAppender#encodedMessageList}
 * to support easy assertions of capture encoded message.
 *
 * @param <E>
 */
public class EncodedMessageCaptureConsoleAppender<E> extends ConsoleAppender<E> {
